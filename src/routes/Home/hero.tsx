...
const Hero = () => {
  ...
  return (
    <motion.main
      ...
      id='home'
      className='pt-15 flex min-h-[75vh] pb-[13rem] flex-col gap-4 lg:pt-25'
    >
      ...
      <a href='#projects'>
        <button
          ...
          className='border-2 hero-btn overflow-hidden  hover:text-neutral-100 transition-colors duration-300 mt-2 border-primary-green hover:border-transparent relative py-3 px-4 w-fit rounded-3xl '
        >
          See Projects
        </button>
      </a>
